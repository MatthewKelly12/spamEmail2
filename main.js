...
const allEmails = customers.customers.forEach(
    function (customer) {
        customer.contacts.email.forEach(
            function (email) {
...
emailArray.forEach(
    function (email) {
        ...
        const parEmail = document.createElement("p");
        parEmail.textContent = email;
        art.appendChild(parEmail);
    }
)
